...
function getDefaults() {
  return {
    ...
    autoMod: { enabled: false, words: [], allowedWords: [], regexWords: [], blockLinks: false, phishingProtection: false, aiFilter: false, aiPrompt: '', logChannelId: '', punishment: 'delete', timeoutMinutes: 10, logLevel: 'all', strikes: {}, strikeResetHours: 24, userStrikes: {} },
    roleGive: { channelId: '' },
